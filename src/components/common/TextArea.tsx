      ...
      <div className="relative">
        ...
        {shouldShowClear && (
          <button
            ...
            className="absolute right-3 bottom-3 rounded-full bg-white/60 px-2 py-1 text-xs font-medium text-slate-500 transition hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/40"
          >
            Clear
          </button>
        )}
